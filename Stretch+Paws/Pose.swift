...
class Poses {
  var poseData = [
    Pose(
      ...
      topTip: "Bend your knees in order to create more length through the spine.", poseDuration: 30 ),
    Pose(
      ...
      topTip: "Try interlacing your hands behind your back for another variation!", poseDuration: 40 ),
    Pose(
      name: "Tree Pose",
      asana: "Vrksasana",
      icon: "Cat-3",
      ...
      topTip: "If you feel steady, lift your arms up to the ceiling. If you're feeling very brave, close one or both eyes!", poseDuration: 50 ),
    Pose(
      name: "Boat Pose",
      asana: "Navasana",
      icon: "Cat-4",
      ...
      topTip: "Reach your arms up over your head for an extra challenge!", poseDuration: 30),
    Pose(
      name: "Child's Pose",
      asana: "Balasana",
      icon: "Cat-5",
      ...
      topTip: "Reach both arms over to one side for a great side stretch and repeat on the other side!", poseDuration: 40),
    Pose(
      name: "Lotus Pose",
      asana: "Padmasana",
      icon: "Cat-6",
      ...
      topTip: "If the pose gets too intense, you can always meditate in a simple cross-legged position.", poseDuration: 20),
    Pose(
      name: "Dancer's Pose",
      asana: "Natarajasana",
      icon: "Cat-7",
      ...
      topTip: "Keep the chest lifted and the heart open while trying to lift the leg higher!", poseDuration: 30),
    Pose(
      ...
      topTip: "Bend into the standing leg and use the bend to hop up into a handstand – if you dare!", poseDuration: 40),
    Pose(
      name: "Forearm Stand",
      ...
      topTip: "Try this against a wall to begin with!", poseDuration: 30),
    Pose(
      name: "Plough Pose",
      asana: "Halasana",
      icon: "Cat-10",
      ...
      topTip: "To come out of this pose, take the hands to the lower back and lower down slowly.", poseDuration: 20),
